function [dem_plane_r,dem_plane_c]= projectPixel(dim,dem,dem_base,...
...
%     dim_expd=1000;% 1000 buffer
    ...
    dem_plane_r(tmp_id_plane)=round(loc_i);
    dem_plane_c(tmp_id_plane)=round(loc_j);
